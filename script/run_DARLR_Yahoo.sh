...
# Episode 退出机制 (对齐 src/core/util/data.py::YahooEnv-v0 默认)
export MAX_TURN="${MAX_TURN:-30}"
export FORCE_LENGTH="${FORCE_LENGTH:-10}"
export NUM_LEAVE_COMPUTE="${NUM_LEAVE_COMPUTE:-3}"
export LEAVE_THRESHOLD="${LEAVE_THRESHOLD:-120}"

# selector 超参（论文 §5.5：Yahoo 中等 K）
export SELECTOR_K="${SELECTOR_K:-25}"                   # 搜索范围: 25, 50, 75, 100
...
export MESSAGE="${MESSAGE:-DARLR_Yahoo}"
