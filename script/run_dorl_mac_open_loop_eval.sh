...
OUTPUT_ROOT="${OUTPUT_ROOT:-saved_models/KuaiEnv-v0/DORL_MAC/open_loop_K${CHUNK_SIZE}}"
...
MAC_CKPT="${MAC_CKPT:-saved_models/KuaiEnv-v0/DORL_MAC/dorl-mac-kuai-catbc-qv-K${CHUNK_SIZE}/mac_agent/latest.pt}"
